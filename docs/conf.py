# -*- coding: utf-8 -*-
#
# Karr Lab build utilities documentation build configuration file, created by
...
htmlhelp_basename = 'karrlabbuildutilsdoc'
...
man_pages = [
    (master_doc, 'karrlabbuildutils', u'Karr Lab build utilities Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'karrlabbuildutils', u'Karr Lab build utilities Documentation',
     author, 'karrlabbuildutils', 'One line description of project.',
     'Miscellaneous'),
]
...
addmetahtml_content = '<meta http-equiv="refresh" content="0; url=https://docs.karrlab.org/wc_rules" />'
