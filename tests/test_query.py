...
class AnotherObject(base.BaseClass):
    pass

# used for test_nodetypequery


class A(base.BaseClass):
    pass
...
class B1(base.BaseClass):
    pass


class C1(base.BaseClass):
    pass


class D1(base.BaseClass):
    pass
...
class TestQuery(unittest.TestCase):
    ...
    def test_graphquery_compile_traversal_functions(self):
        ...
        for nq in gq.nodequeries:
            str1_arr.append(' '.join(['from', nq.id, 'to', ' '.join(sorted([x.id for x in nq.next_nq]))]))
        str1_arr.sort()
        str2_arr = [
            'from nq0 to nq2 nq5 nq6',
            'from nq1 to nq3 nq4 nq5 nq6',
            'from nq2 to nq0',
            'from nq3 to nq1',
            'from nq4 to nq1',
            'from nq5 to nq0 nq1',
        ...
        self.assertEqual(sorted(str1_arr), str2_arr)
